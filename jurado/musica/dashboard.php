...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['evaluar_participante'])) {
        ...
        $stmt = ejecutarConsulta(
            $conexion,
            "INSERT INTO calificaciones_musica 
            (jurado_id, participante_id, afinacion, ritmo, proyeccion_vocal, interpretacion, creatividad_musica, comentarios_musica) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
            $datos,
            "iiiiiiss"
        );
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Creatividad Musical (0-10 puntos)</label>
                                <input type="number" name="creatividad" min="0" max="10" class="form-control" required>
                                <small class="text-muted">Originalidad en la interpretación y arreglos</small>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">Comentarios Adicionales</label>
                                <textarea name="comentarios" class="form-control" rows="4" placeholder="Observaciones sobre el desempeño musical..."></textarea>
                            </div>
